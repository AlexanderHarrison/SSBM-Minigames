...
static EventMatchData MonkeyMatchData = {
...
static EventMatchData JJMatchData = {
    .timer = MATCH_TIMER_COUNTDOWN,
    .matchType = MATCH_MATCHTYPE_STOCK,
    .isDisableMusic = false,
    .hideGo = false,
    ...
    .playerKind = -1,
    .cpuKind = -1,
    .stage = 5, // kongo jungle
    .timerSeconds = 480,
    .timerSubSeconds = 0,
    .stockCount = 3,
    .itemFreq = MATCH_ITEMFREQ_VERYLOW,
    .itemSwitch = 1ull << 10,
};
...
EventDesc Items = {
    .eventName = "Item Mayhem\n",
    .eventDescription = "Spawn items with D-Pad down!\nUse A and B to select the item.\n",
    .eventFile = "items",
    .isChooseCPU = true,
    .isSelectStage = true,
    .use_savestates = false,
...
EventDesc RJJ = {
    .eventName = "Rishi's Jungle Jam\n",
    .eventDescription = "Stages? Kongo Jungle. Stocks? 3. Timer?\n8 minutes. Items? Starman. Set to very low.\n",
    .eventFile = "jj",
    .isChooseCPU = true,
    .isSelectStage = false,
    .use_savestates = false,
    ...
    .scoreType = 0,
    .callbackPriority = 3,
    .matchData = &JJMatchData,
    .defaultOSD = 0xFFFFFFFF,
};

EventDesc Hitfall = {
    .eventName = "Hitfalling\n",
    .eventDescription = "Press down during hitlag to\nimmediately fastfall.\n",
    .eventFile = "hitfall",
    .isChooseCPU = true,
    .isSelectStage = true,
    .use_savestates = false,
...
EventDesc Meter = {
    .eventName = "Abilities\n",
    .eventDescription = "When your meter is full,\npress L+R+B to active your special ability!\n",
    .eventFile = "meter",
    .isChooseCPU = true,
    .isSelectStage = true,
    .use_savestates = false,
...
void EventInit(int page, int eventID, MatchInit *matchData)
{
    ...
    */
    ...
    for (int i = 0; i < 6; i++)
    {
        ...
        //matchData->playerData[i].isEntry = true;
        matchData->playerData[i].stocks = eventMatchData->stockCount;

        //if (
        //matchData->playerData[3].c_kind = CKIND_FOX;
        //matchData->playerData[3].costume = 0;
        //matchData->playerData[3].portNumberOverride = 4;
        //matchData->playerData[3].p_kind = PKIND_HMN;
...
void OnBoot()
{
    //(*stc_css_minorscene) = &data;
    //static const u8 ko_stars[6] = {0};
    //(*stc_css_minorscene)->ko_data = ko_stars;
    //*(int*)0x802663d0 = 0x60000000;
    //*(int*)0x8025e010 = 0x60000000;
